...
// =============================================
// CÁLCULO DE FECHAS DINÁMICAS (semana anterior: martes a lunes)
// =============================================
...
SELECT DISTINCT
    ...
    COALESCE((
        ...
        AND m.timecreated >= EXTRACT(EPOCH FROM TO_TIMESTAMP('$fecha_inicio', 'YYYY-MM-DD HH24:MI:SS'))
        AND m.timecreated <= EXTRACT(EPOCH FROM TO_TIMESTAMP('$fecha_fin', 'YYYY-MM-DD HH24:MI:SS'))
    ...
    CASE 
        WHEN EXISTS (
            ...
            AND m.timecreated = (
                ...
                AND m2.timecreated >= EXTRACT(EPOCH FROM TO_TIMESTAMP('$fecha_inicio', 'YYYY-MM-DD HH24:MI:SS'))
                AND m2.timecreated <= EXTRACT(EPOCH FROM TO_TIMESTAMP('$fecha_fin', 'YYYY-MM-DD HH24:MI:SS'))
            )
            LIMIT 1
        )
        ELSE 'No ha enviado mensajes'
