...
try {
    ...
    $mail->Subject = 'Reporte de Mensajes Semanal del programa de regencia cohorte 2 Semestre 1-'. $fecha_para_nombre;
    $mail->Body = "Cordial Saludo,<br><br>
                 Adjunto el Reporte de Mensajería Semanal del programa de regencia cohorte 2 Semestre 1.<br><br>
    ...
    if (file_exists($zip_file)) {
        $mail->addAttachment($zip_file, "reporte_mensajeria_regencia_c2_s1_{$fecha_para_nombre}.zip");
    }
