...
// Calcular fechas: inicio fijo el 3 de febrero de 2025, fin el lunes más reciente
$fecha_inicio_fija = new DateTime('2025-02-03'); 
...
$fecha_inicio = $fecha_inicio_fija->format('Y-m-d 00:00:00'); // Siempre 2025-02-03 00:00:00
...
try {
    ...
    $mail->Subject = 'Reporte de Ingresos y Mensajes Acumulado del Diplomado en Gestion de Proyectos  - ' . $fecha_para_nombre;
    $mail->Body = 'Cordial Saludo, Adjunto el Reporte de Ingresos y Mensajes Acumulado del Diplomado en Gestion de Proyectos, que contiene los archivos de estudiantes y profesores.';
    if (file_exists($zip_file)) {
        $mail->addAttachment($zip_file, "reporte_asignaturas_dgp_{$fecha_para_nombre}.zip");
    }
    $mail->send();
    ...
    mail($correo_notificacion, 'Estado Reporte', 'El reporte del Diplomado en Gestion de Proyectos fue enviado correctamente.');
} catch (Exception $e) {
