...
// Establecer la zona horaria Bogotá para corregir desfase de tiempo
...
try {
    ...
    // Obtener nombres y fechas de actividades del curso de referencia (primer curso)
    ...
    // Añadir encabezados dinámicos para foros
    ...
    // Añadir encabezados dinámicos para lecciones
    ...
    // Añadir encabezados dinámicos para tareas
    ...
    // Añadir encabezados dinámicos para quizzes
    ...
    // Añadir encabezados dinámicos para glosarios
    ...
    // Añadir encabezados dinámicos para SCORM
    ...
    foreach ($cursos as $curso_id) {
        // Crear tablas temporales para el curso actual
    ...
    $mail->Subject = 'Reporte de actividades Diplomado en Gestion de Proyectos - ' . $hoy->format('Y-m-d');
    $mail->Body = 'Cordial Saludo, Adjunto el Reporte de actividades Diplomado en Gestion de Proyectos.';
    $mail->addAttachment($tempFilePath, 'reporte_actividades_dgp.xlsx');
    $mail->send();

    fclose($tempFile);

    mail($correo_notificacion, 'Estado Reporte', 'El reporte de actividades del DGP fue enviado correctamente.');
} catch (Exception $e) {
