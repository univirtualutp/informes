...
try {
    ...
    $mail->Subject = 'Reporte de Ingresos y Mensajes Semanal del Diplomado en Gestion de proyectos  - ' . $fecha_para_nombre;
    $mail->Body = 'Cordial Saludo, Adjunto el Reporte de Ingresos y Mensajes Semanal del diplomado en gestion de proyectos, que contiene los archivos de estudiantes y profesores.';
