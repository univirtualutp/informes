...
$cursos_seleccionados = [
    '851','852','845','846','849','850','847','848'
];
...
try {
    ...
    $mail->Subject = "Reporte de actividades programa de regencia cohorte 1 Semestre 2 - " . $hoy->format('Y-m-d');
    $mail->Body = "Cordial Saludo,\n\nAdjunto el reporte de actividades programa de regencia cohorte 1 Semestre 2 en un archivo ZIP.";
    ...
    // Notificar éxito
    mail($correo_notificacion, "Estado Reporte", "El reporte de actividades programa de regencia cohorte 1 Semestre 2 fue enviado correctamente.");
