...
try {
    ...
    $mail->setFrom('noreply-univirtual@utp.edu.co', 'Reporte Moodle Regencia Actividades');
    ...
    // Manejo de errores
    error_log("Error en actividadesRegencia.php: " . $e->getMessage());
